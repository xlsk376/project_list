...
public class 쇼핑몰_데이터베이스 {
	...
	public static void main(String[] args) {
		...
		String[][] itemList= {
				...
				{"2003","가전","이어폰","90000","일반", "0", "3일", "6000개"},
				{"2003","가전","무선충전기","35000","할인", "28000", "4일", "68개"},
				{"2003","가전","모니터","650000","일반", "0", "3일", "102개"},
				{"2003","가전","충전케이블","12000","일반", "0", "2일", "4626개"},
				{"2003","가전","카메라","1267000","할인", "1013600", "10일", "13개"},
				{"2003","가전","에어컨","1897000","할인", "1517600", "10일", "15개"},

				{"3001","식품","돼지고기","21000","일반", "0"," 1일","100개"},
				{"3002","식품","소고기","43000","일반", "0"," 1일","81개"},
				{"3003","식품","유정란","9200","일반", "0"," 1일","100개"},
				{"3004","식품","닭가슴살","1190","일반", "0"," 1일","232개"},
				{"3005","식품","연어회","44000","일반", "0"," 3일","0개"},
		...
		String orderList[][]= {
				...
				/*
				 * 11.식품을 구매한 사람조회 -권지호,설이홍,양현영
				 * 
				 * 12.제품을 2개이상 구매한사람조회 -박미현,전이서,권지호
				 * 
				 * 13.10만원이상제품의 상품번호 조회 -1002,1009
				 * 
				 * 14.아이디에 'b'가들어간 사람의 번호 조회 -2264,2240
				 * 
				 * 15.의류를 구매한 회원 중 160cm 이하인 회원을 조회하세요. -박미현
				 * 
				 * 16. 상품번호가 2000번대인 상품 중에 판매가가 가장 낮은 상품을 조회하세요. -충전케이블
				 * 
				 * 17.회원등급이 A이고 구독제 회원인 사람이 구매한 상품조회 -에어컨
				 * 
				 * 18.가전을 구매한 회원 중 A등급 회원을 조회하세요. -강석주
				 * 
				 * 19. 할인품목에서 재고가 없는 상품을 조회하세요. -연어회 3005
				 * 
				 * 20.같은 상품을 구매한 사람 중 무료배송인 사람을 조회하세요 -조대운
				 */
